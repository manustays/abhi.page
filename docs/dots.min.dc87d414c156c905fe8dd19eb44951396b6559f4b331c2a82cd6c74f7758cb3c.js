...
var stopAnimation=function(){stop=true;canvas.removeEventListener('mousemove',processMouse);}
...
function startAnimating(fps){fpsInterval=1000/fps;then=Date.now();animate();setTimeout(stopAnimation,30000);if(mobile!==true){canvas.addEventListener('mousemove',processMouse);}}
startAnimating(30);